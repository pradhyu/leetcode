...
/**
 * Connection wrapper that tracks usage for leak detection.
 */
public class TrackedConnection implements Connection {
    ...
    public TrackedConnection(Connection delegate, String connectionId, ConnectionManager connectionManager) {
    ...
    // Getter for connection ID (for debugging)
